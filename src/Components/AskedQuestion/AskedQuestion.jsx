...
function AskedQuestion() {
        ...
        const [Question,setQuewstion]= useState([{question:"Paint point description and our solution?" , show: false},
            ...
            <div className="content_padding">
                ...
                <div className="mt-3">
                    ...
                    {Question.map((item,index) =>(
                         <Card className="pt-1 pb-1 Card_shadow mt-2" >
                         <div className="p-2">
                             <span>
                                 {item.show === false?(<span  className="hover_cursor icon_size"
                             onClick={()=>{
                                        Question[index].show =true;
                                        setQuewstion([...Question,])
                             ...
                             <span  className="hover_cursor icon_size1"
                             onClick={()=>{
                                Question[index].show =false;
                                setQuewstion([...Question,])

                     }}
                                 
                             > <i className="fa fa-minus-square"></i></span>)}
                           ...
                           <span className="ml-3 asked_question">{item.question}</span>
