            ...
            <div className="mt-5 ml-4 mr-4">
                ...
                <Grid className="Component_main_grid mt-2 p-3 ">
                    ...
                    <Grid item md={3} className="p-3">
                        ...
                        <div className="Footer_heading_Links mt-1" onClick={() => props.history.push("/about")}>ABOUT</div>
                        ...
                        <div className="Footer_heading_Links mt-1" onClick={() => props.history.push("./contact")}>Contact Us</div>
